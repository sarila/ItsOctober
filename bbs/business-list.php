            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="business-box">
                        <div class="list-img"><img src="assets/img/sale/sale-1.jpg">
                            <span class="for">For Sell</span></div>
                        <div class="business-body">
                            <div class="price-tags">
                                <span class="rent"> Rent:$1,850 per/M </span>
                                <span class="cost"> $6,0000</span>
                            </div>
                            <h5><a href="business-detail.php">7012 Shine Sehu Street, Liverpool London, LC345AC</a></h5>
                            ...
                            <div class="low d-flex ">
                                <div class="location-list "> <i class="fas fa-map-marker-alt"></i> Montreal,
                                    Canada</div>
                                <div class="end-buttons" data-toggle="tooltip" title="Save Business"><i
                                        class="far fa-heart"></i></div>
                                <div class="end-buttons" data-toggle="tooltip" title="Compare Business"> <i
                                        class="fas fa-random"></i></div>
                                <div class="end-buttons" data-toggle="tooltip" title="View Business"> <i
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="business-box">
                        <div class="list-img"><img src="assets/img/sale/sale-3.jpg">
                            <span class="for">For Sell</span></div>
                        <div class="business-body">
                            <div class="price-tags">
                                <span class="rent"> Rent:$1,850 per/M</span>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="business-box">
                        <div class="list-img"><img src="assets/img/sale/sale-4.jpg">
                            <span class="for">For Sell</span></div>
                        <div class="business-body">
                            <div class="price-tags">
                                <span class="rent"> Rent:$1,850 per/M</span>
