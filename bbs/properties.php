        ...
        <div class=" user-profile-item ">
          ...
          <div class="item-box">
            <div class="title-container"><img src="assets/img/sale/sale-1.jpg" alt="">
              <div class="title">
                <h4><a href="business-detail.php">Renovated Luxury Apartment</a></h4>
                <span>2021 San Pedro, Los Angeles 90015</span> <span class="property-price">$22,000/mo</span>
              </div>
              <div class="date">
                <p>2 Sep, 2021</p>
              </div>
              <div class="action  prop-ac">
                <a href="business-detail.php" class="view  " data-toggle="tooltip" data-placement="left" title="View"><i
                    class="far fa-eye"></i>
                </a>
                <a href="edit.php" class="edit  " data-toggle="tooltip" data-placement="left" title="Edit"><i
                    class="far fa-edit"></i>
                </a>

                <a href="#" class="delete  " data-toggle="tooltip" data-placement="left" title="Delete"><i
          ...
          <div class="item-box">
            <div class="title-container"><img src="assets/img/sale/sale-2.jpg" alt="">
              <div class="title">
                <h4><a href="business-detail.php">Renovated Luxury Apartment</a></h4>
                <span>2021 San Pedro, Los Angeles 90015</span> <span class="property-price">$20,000/mo</span>
              </div>
                <div class="date">
                <p>2 Sep, 2021</p>
              </div>
          ...
          <div class="item-box">
            <div class="title-container"><img src="assets/img/sale/sale-3.jpg" alt="">
              <div class="title">
                <h4><a href="business-detail.php">Renovated Luxury Apartment</a></h4>
                <span>2021 San Pedro, Los Angeles 90015</span> <span class="property-price">$15,000/mo</span>
              </div>
                <div class="date">
                <p>2 Sep, 2021</p>
              </div>
          ...
          <div class="item-box">
            <div class="title-container"><img src="assets/img/sale/sale-4.jpg" alt="">
              <div class="title">
                ...
                <span>2021 San Pedro, Los Angeles 90015</span> <span class="property-price">$18,000/mo</span>
              </div>
                <div class="date">
                <p>2 Sep, 2021</p>
              </div>
